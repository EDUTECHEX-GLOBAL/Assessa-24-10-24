...
import { InputItemListParams, InputItems, ResponseItemList, ResponseItemListDataPage } from "./input-items.js";
...
export type ParsedResponseOutputItem<ParsedT> = ParsedResponseOutputMessage<ParsedT> | ParsedResponseFunctionToolCall | ResponseFileSearchToolCall | ResponseFunctionWebSearch | ResponseComputerToolCall | ResponseReasoningItem;
...
export declare class Responses extends APIResource {
     ...
     */
    retrieve(responseId: string, query?: ResponseRetrieveParams, options?: Core.RequestOptions): Core.APIPromise<Response>;
 ...
 */
export type ResponseOutputItem = ResponseOutputMessage | ResponseFileSearchToolCall | ResponseFunctionToolCall | ResponseFunctionWebSearch | ResponseComputerToolCall | ResponseReasoningItem;
/**
...
export interface ResponseTextAnnotationDeltaEvent {
     ...
     * A citation to a file.
     */
    annotation: ResponseTextAnnotationDeltaEvent.FileCitation | ResponseTextAnnotationDeltaEvent.URLCitation | ResponseTextAnnotationDeltaEvent.FilePath;
    /**
...
export declare namespace ResponseTextAnnotationDeltaEvent {
    /**
     * A citation to a file.
     */
    interface FileCitation {
...
export declare namespace Responses {
    export { InputItems as InputItems, type ResponseItemList as ResponseItemList, ResponseItemListDataPage as ResponseItemListDataPage, type InputItemListParams as InputItemListParams, };
}
