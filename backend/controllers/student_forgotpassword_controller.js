...
const ForgotPassword = require("../models/webapp-models/student_forgotpassword_model");
const Student = require("../models/webapp-models/userModel"); // Your student model for updating the password
