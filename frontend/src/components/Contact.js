...
export default function Contact() {
  ...
  return (
    <div
      id="contacts"
      className="bg-gradient-to-br from-pink-500 via-red-400 to-yellow-500 rounded-lg overflow-hidden shadow-lg"
    >
      <div className="flex flex-col lg:flex-row">
        {/* Left Section */}
        <div className="w-full lg:w-1/2 py-10 px-8 lg:p-12 bg-gradient-to-br from-yellow-500 via-red-400 to-yellow-500 flex flex-col justify-center items-center">
        ...
        <form
          ...
          className="w-full lg:w-1/2 py-10 px-8 lg:p-12 bg-gradient-to-br from-yellow-500 via-red-400 to-yellow-500"
        >
          ...
          <input
            ...
            className="w-full py-3 px-4 bg-white rounded-md text-lg text-gray-800 mb-4 focus:outline-none focus:ring-2 focus:ring-red-500"
            value={name}
          ...
          <textarea
            ...
            className="w-full py-3 px-4 bg-white rounded-md text-lg text-gray-800 mb-6 h-32 focus:outline-none focus:ring-2 focus:ring-red-500"
            value={message}
