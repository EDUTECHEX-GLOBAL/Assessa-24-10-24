...
export default function StudentNotificationBell({ setSelectedSection, studentToken }) {
  ...
  const fetchRecentNotifications = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/api/notifications/student?limit=5&unreadOnly=true`,
        getAuthConfig()
      );
